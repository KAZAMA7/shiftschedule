...
class AssociatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create associate" do
    assert_difference('Associate.count') do
      post associates_url, params: { associate: { group: @associate.group, irc_nick: @associate.irc_nick, mail_id: @associate.mail_id, manager: @associate.manager, name: @associate.name, phone: @associate.phone } }
    end
  ...
  test "should update associate" do
    patch associate_url(@associate), params: { associate: { group: @associate.group, irc_nick: @associate.irc_nick, mail_id: @associate.mail_id, manager: @associate.manager, name: @associate.name, phone: @associate.phone } }
